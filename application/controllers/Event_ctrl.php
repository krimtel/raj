...
class Event_ctrl extends CI_Controller {
	...
	function event_gallery_data(){ 
     ...
     function contact_mail(){ //print_r($this->input->post()); die;
		
	$email = $this->input->post('email');
        $message = $this->input->post('contact_desc');
        $mail_opt = $this->input->post('mail_opt');
        $con_us_name = $this->input->post('con_us_name');
        $con_us_contact = $this->input->post('con_us_contact');
        $con_us_add =  $this->input->post('con_us_add');
         $con_us_stak = $this->input->post('con_us_stak');
	//echo $con_us_contact ; die;
	$config = Array(
  'protocol' => 'smtp',
