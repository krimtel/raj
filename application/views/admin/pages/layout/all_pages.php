					...
					foreach($pages as $page){ ?>
                		<tr>
                  			...
                  			<?php if($page['is_static']){ ?>
                  				<td><a target="_blank"href="<?php echo base_url().$page['url']; ?>"><?php echo base_url().$page['url']; ?></a></td>
                  			<?php } else {?>
                  				<td><a target="_blank"href="<?php echo base_url().$page['cms_url']; ?>"><?php echo base_url().$page['cms_url']; ?></a></td>
							<?php } ?>
                  			<td>
                  				...
                  				<a title="Delete" href="#" class="class_delete btn btn-info btn-flat page_delete" data-page_id="<?php echo$page['p_id'];?>"><i class="fa fa-trash"></i></a>
                  			</td>
                		</tr>
                	<?php $c++; } ?>
            	</tbody>
