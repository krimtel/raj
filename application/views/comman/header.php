...
<span><?php echo $this->lang->line('language');?></span>
				...
				<div class="header-right-list" style="border-right:0px;" >
					<a class="border" target="_blank" href="http://www.enam.gov.in/NAM/faces/infrastructure/SLogin.jsf" title="Login"><img alt="Help No" src="<?php echo base_url(); ?>/assest/images/new-theme/login-user.png" />
